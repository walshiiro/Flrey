...
async def char(ctx, uid):
    ...
    if numberChar != 0:
        ...
        CRITRate = userdata['avatarInfoList'][0]['fightPropMap']['20'] * 100
        CritDMG = userdata['avatarInfoList'][0]['fightPropMap']['22'] * 100
        ER = userdata['avatarInfoList'][0]['fightPropMap']['23']
        EM = userdata['avatarInfoList'][0]['fightPropMap']['28']
        WeaponID = userdata['avatarInfoList'][0]['equipList'][5]['flat']['nameTextMapHash']
        WeaponLevel = userdata['avatarInfoList'][0]['equipList'][5]['weapon']['level']
        WeaponName = weapon['en'][WeaponID]
        BaseATK = userdata['avatarInfoList'][0]['equipList'][5]['flat']['weaponStats'][0]['statValue']
        anotherfromweaponidfkwtfisthat = userdata['avatarInfoList'][0]['equipList'][5]['flat']['weaponStats'][1][
            'appendPropId']
        base2stats = userdata['avatarInfoList'][0]['equipList'][5]['flat']['weaponStats'][1]['statValue']
